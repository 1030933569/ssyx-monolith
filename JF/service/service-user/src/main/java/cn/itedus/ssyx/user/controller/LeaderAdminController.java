...
public class LeaderAdminController {
    ...
    @ApiOperation("List pending leaders")
    ...
    @ApiOperation("List approved leaders")
    ...
    @ApiOperation("Batch delete leaders")
